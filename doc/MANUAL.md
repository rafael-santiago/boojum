...
For ``HKDF``'s hash function ``SHA-3/512`` has been taken. I also have been using
my own cross-platform/"cross-space" ``crypto`` library called [kryptos](https://github.com/rafael-santiago/kryptos).
